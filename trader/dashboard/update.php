...
if(isset($_POST['updateProduct'])){  
    ...
    if($check == 13){              
        ...
        $fileDestination = "ProductImage/$fileName";
        $fileDestination1 = 'ProductImage/' . $fileName1;
        $fileDestination2 = 'ProductImage/' . $fileName2;
        $fileDestination3 = 'ProductImage/' . $fileName3;
        $fileDestination4 = 'ProductImage/' . $fileName4;
        ...
        $sql = "UPDATE Product SET (
            ...
            product_image2 ='$fileName1',
            product_image3 ='$fileName2',
            product_image4='$fileName3',
            product_image5='$fileName4',
