...
//    $mail->addAddress('receiver2@gfg.com', 'Name');
    ...
    $_SESSION['trader-otp-message'] = "OTP has been re-send to your email !";
} catch (Exception $e) {
    $_SESSION['trader-otp-message'] = "OTP could be re-send. Try later !";
}
header('Location: ../trader/traderregistration.php');
