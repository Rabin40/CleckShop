...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        ...
        <table id="showreview" class="table table-striped table-bordered" style="width:100%">
            <thead>
                    <tr>
                        <th>Reviews </th>
                    </tr>
            ...
            <tbody>
                ...
                $sql = "SELECT * from question_review where review_rating is not null and status = 1 and customer_id = $cid";
                $qry = oci_parse($conn, $sql);
                $execute = oci_execute($qry);
