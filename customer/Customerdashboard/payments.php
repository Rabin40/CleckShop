...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        ...
        <table id="showpayments" class="table table-striped table-bordered" style="width:100%">
        <thead>
            <tr>
                <th>Payment Id</th>
        ...
        <tbody>
                <?php
                    ...
                    include('../../connection/connect.php');
                    $sql = "SELECT * from Payment where order_id IN (Select order_id from cleckshop_order where cart_id IN (select cart_id from cart where customer_id = $cid)) ";
                    $qry = oci_parse($conn, $sql);
                    $execute = oci_execute($qry);
